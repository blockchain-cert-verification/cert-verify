...
contract Certification {
    ...
    function generateCertificate(
        ...
        require(certificates[byte_id].duration == 0, "Certificate with given id already exists");
        certificates[byte_id] = Certificate(_candidate_name, _org_name, _course_name, _duration);
    ...
    function getData(string memory _id) public view returns(string memory, string memory, string memory, uint256) {
        ...
        require(temp.duration != 0, "No data exists");
        return (temp.candidate_name, temp.org_name, temp.course_name, temp.duration);
    }
}