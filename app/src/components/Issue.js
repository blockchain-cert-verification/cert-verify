...
//import { generateCertificate } from "./formApi";
...
class Issue extends React.Component {
  state = {
    ...
    lastname: "",
    organization: "IGDTUW",
    orgLogo: "https://upload.wikimedia.org/wikipedia/en/4/4e/Indira_Gandhi_Delhi_Technical_University_for_Women_logo.png",
    coursename: "",
    assignedOn: null,
    duration: 0,
    currentState: "normal",
  ...
  submitData = event => {
    ...
    const newCert = {
      ...
      assignedOn: this.state.assignedOn,
      duration: this.state.duration,
      emailId: this.state.emailId
    }
    axios.post('http://localhost:3001/issuecert', newCert);
        ...
        <Grid item xs={12} sm={8}>
          <Paper className={classes.paper}>
            ...
            >
              ...
              <Grid item xs={12} sm={12}>
                <input type="submit"
                name="submit" className={classes.submitBtn} onClick={this.submitData}></input>
                {/* <SubmitAnimation
                  helperText="Submit"
